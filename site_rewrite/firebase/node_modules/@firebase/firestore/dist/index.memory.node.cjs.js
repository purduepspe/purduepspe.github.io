...
function canonifyArray(arrayValue) {
    var result = '[';
    var first = true;
    for (var _i = 0, _a = arrayValue.values || []; _i < _a.length; _i++) {
        var value = _a[_i];
        if (!first) {
            result += ',';
        }
...
var IndexFreeQueryEngine = /** @class */ (function () {
    ...
    IndexFreeQueryEngine.prototype.applyQuery = function (query, documents) {
        ...
        var queryResults = new SortedSet(function (d1, d2) {
            return query.docComparator(d1, d2);
        });
...
var ObjectValue = /** @class */ (function () {
    function ObjectValue(proto) {
        this.proto = proto;
        assert(!isServerTimestamp(proto), 'ServerTimestamps should be converted to ServerTimestampValue');
    }
    ...
    ObjectValueBuilder.prototype.applyOverlay = function (currentPath, currentOverlays) {
        ...
        var resultAtPath = isMapValue(existingValue)
            ? // If there is already data at the current path, base our
             tslib.__assign({}, existingValue.mapValue.fields) : {};
...
var TransformMutation = /** @class */ (function (_super) {
    ...
    TransformMutation.prototype.isEqual = function (other) {
        return (other instanceof TransformMutation &&
            this.key.isEqual(other.key) &&
            arrayEquals(this.fieldTransforms, other.fieldTransforms, function (l, r) {
                return l.isEqual(r);
            }) &&
            this.precondition.isEqual(other.precondition));
    };
...
var TargetData = /** @class */ (function () {
    ...
    TargetData.prototype.isEqual = function (other) {
...
var LocalStore = /** @class */ (function () {
    ...
    LocalStore.shouldPersistTargetData = function (oldTargetData, newTargetData, change) {
        assert(newTargetData.resumeToken.approximateByteSize() > 0, 'Attempted to persist target data with no resume token');
    ...
    LocalStore.prototype.getNewDocumentChanges = function () {
        var _this = this;
        return this.persistence
            .runTransaction('Get new document changes', 'readonly', function (txn) {
            return _this.remoteDocuments.getNewDocumentChanges(txn, _this.lastDocumentChangeReadTime);
        })
            .then(function (_a) {
            var changedDocs = _a.changedDocs, readTime = _a.readTime;
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.lastDocumentChangeReadTime = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
...
var LruScheduler = /** @class */ (function () {
    ...
    LruScheduler.prototype.scheduleGC = function (localStore) {
        ...
        this.gcTask = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */, delay, function () {
            _this.gcTask = null;
            _this.hasRun = true;
            return localStore
                .collectGarbage(_this.garbageCollector)
                .then(function () { return _this.scheduleGC(localStore); })
...
var TargetIdGenerator = /** @class */ (function () {
    ...
    TargetIdGenerator.forTargetCache = function () {
        ...
        var targetIdGenerator = new TargetIdGenerator(0 /* QueryCache */, 2);
        return targetIdGenerator;
    };
    TargetIdGenerator.forSyncEngine = function () {
        // Sync engine assigns target IDs for limbo document detection.
        return new TargetIdGenerator(1 /* SyncEngine */);
    };
    return TargetIdGenerator;
}());
 ...
 * limitations under the License.
 */
var LOG_TAG$1 = 'SharedClientState';
/**
...
var WebStorageSharedClientState = /** @class */ (function () {
    ...
    WebStorageSharedClientState.prototype.handleWebStorageEvent = function (event) {
        ...
        if (event.storageArea === this.storage) {
            logDebug(LOG_TAG$1, 'EVENT', event.key, event.newValue);
 ...
 * limitations under the License.
 */
var LOG_TAG$2 = 'MemoryPersistence';
...
var MemoryPersistence = /** @class */ (function () {
    ...
    MemoryPersistence.prototype.mutationQueuesContainKey = function (transaction, key) {
        return PersistencePromise.or(Object.values(this.mutationQueues).map(function (queue) { return function () {
...
var MemoryPersistenceProvider = /** @class */ (function () {
    ...
    MemoryPersistenceProvider.prototype.initialize = function (asyncQueue, databaseInfo, platform, clientId, initialUser, settings) {
        if (settings.durable) {
    ...
    MemoryPersistenceProvider.prototype.getGarbageCollectionScheduler = function () {
        var started = false;
        return {
            started: started,
            start: function () { return (started = true); },
            stop: function () { return (started = false); }
        };
    };
    MemoryPersistenceProvider.prototype.getPersistence = function () {
        assert(!!this.clientId, 'initialize() not called');
        return new MemoryPersistence(this.clientId, function (p) { return new MemoryEagerDelegate(p); });
    };
    MemoryPersistenceProvider.prototype.getSharedClientState = function () {
        return new MemorySharedClientState();
    };
    MemoryPersistenceProvider.prototype.clearPersistence = function () {
        throw new FirestoreError(Code.FAILED_PRECONDITION, MEMORY_ONLY_PERSISTENCE_ERROR_MESSAGE);
    };
 ...
 * limitations under the License.
 */
var LOG_TAG$3 = 'ExponentialBackoff';
/**
...
var ExponentialBackoff = /** @class */ (function () {
    ...
    ExponentialBackoff.prototype.backoffAndRun = function (op) {
        ...
        if (this.currentBaseMs > 0) {
            logDebug(LOG_TAG$3, "Backing off for " + remainingDelayMs + " ms " +
...
var PersistentStream = /** @class */ (function () {
    ...
    PersistentStream.prototype.start = function () {
        ...
        assert(this.state === 0 /* Initial */, 'Already started');
        this.auth();
    };
    /**
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert(finalState === 3 /* Error */ || isNullOrUndefined(error), "Can't provide an error when not in an error state.");
    ...
    PersistentStream.prototype.auth = function () {
        var _this = this;
        assert(this.state === 0 /* Initial */, 'Must be in initial state to auth');
    ...
    PersistentStream.prototype.startStream = function (token) {
        var _this = this;
        assert(this.state === 1 /* Starting */, 'Trying to start stream in a non-starting state');
        var dispatchIfNotClosed = this.getCloseGuardedDispatcher(this.closeCount);
        this.stream = this.startRpc(token);
        this.stream.onOpen(function () {
            dispatchIfNotClosed(function () {
                assert(_this.state === 1 /* Starting */, 'Expected stream to be in state Starting, but was ' + _this.state);
                _this.state = 2 /* Open */;
    ...
    PersistentStream.prototype.performBackoff = function () {
        var _this = this;
        assert(this.state === 3 /* Error */, 'Should only perform backoff when in Error state');
        this.state = 4 /* Backoff */;
        this.backoff.backoffAndRun(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                assert(this.state === 4 /* Backoff */, 'Backoff elapsed but state is now: ' + this.state);
                this.state = 0 /* Initial */;
                this.start();
...
var PersistentWriteStream = /** @class */ (function (_super) {
    ...
    PersistentWriteStream.prototype.writeMutations = function (mutations) {
        ...
        assert(this.lastStreamToken.approximateByteSize() > 0, 'Trying to write mutation without a token');
        var request = {
    ...
    OnlineStateTracker.prototype.handleWatchStreamStart = function () {
        ...
        if (this.watchStreamFailures === 0) {
            ...
            this.onlineStateTimer = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */, ONLINE_STATE_TIMEOUT_MS, function () {
                ...
                assert(_this.state === "Unknown" /* Unknown */, 'Timer should be canceled if we transitioned to a different state.');
...
var WatchChangeAggregator = /** @class */ (function () {
    ...
    WatchChangeAggregator.prototype.forEachTarget = function (targetChange, fn) {
        if (targetChange.targetIds.length > 0) {
            ...
            this.targetStates.forEach(function (_, targetId) { return fn(targetId); });
        }
    };
    /**
    ...
    WatchChangeAggregator.prototype.resetTarget = function (targetId) {
        var _this = this;
        assert(!this.targetStates.get(targetId).isPending, 'Should only reset active targets');
...
var RemoteStore = /** @class */ (function () {
    ...
    RemoteStore.prototype.unlisten = function (targetId) {
        assert(this.listenTargets.has(targetId), "unlisten called on target no currently watched: " + targetId);
...
var Target = /** @class */ (function () {
    ...
    Target.prototype.canonicalId = function () {
        if (this.memoizedCanonicalId === null) {
            ...
            canonicalId += '|f:';
            canonicalId += this.filters.map(function (f) { return f.canonicalId(); }).join(',');
            canonicalId += '|ob:';
            canonicalId += this.orderBy.map(function (o) { return o.canonicalId(); }).join(',');
...
var Query = /** @class */ (function () {
    ...
    function Query(path, collectionGroup, explicitOrderBy, filters, limit, limitType, startAt, endAt) {
        ...
        if (filters === void 0) { filters = []; }
        if (limit === void 0) { limit = null; }
        if (limitType === void 0) { limitType = "F" /* First */; }
        if (startAt === void 0) { startAt = null; }
        if (endAt === void 0) { endAt = null; }
        this.path = path;
        this.collectionGroup = collectionGroup;
...
var FieldFilter = /** @class */ (function (_super) {
    ...
    FieldFilter.create = function (field, op, value) {
        if (field.isKeyField()) {
            if (op === Operator.IN) {
                assert(isArray(value), 'Comparing on key with IN, but filter value not an ArrayValue');
                assert((value.arrayValue.values || []).every(function (elem) { return isReferenceValue(elem); }), 'Comparing on key with IN, but an array value was not a RefValue');
                return new KeyFieldInFilter(field, value);
            }
            else {
                assert(isReferenceValue(value), 'Comparing on key, but filter value not a RefValue');
            ...
            assert(isArray(value), 'IN filter has invalid value: ' + value.toString());
            return new InFilter(field, value);
        }
        else if (op === Operator.ARRAY_CONTAINS_ANY) {
            assert(isArray(value), 'ARRAY_CONTAINS_ANY filter has invalid value: ' + value.toString());
...
var KeyFieldInFilter = /** @class */ (function (_super) {
    ...
    function KeyFieldInFilter(field, value) {
        ...
        _this.keys = (value.arrayValue.values || []).map(function (v) {
            assert(isReferenceValue(v), 'Comparing on key with IN, but an array value was not a ReferenceValue');
    ...
    Bound.prototype.sortsBeforeDocument = function (orderBy, doc) {
        ...
        for (var i = 0; i < this.position.length; i++) {
            ...
            if (orderByComponent.field.isKeyField()) {
                assert(isReferenceValue(component), 'Bound has a non-key value where the key path is being used.');
...
var SyncEngine = /** @class */ (function () {
    ...
    SyncEngine.prototype.removeAndCleanupTarget = function (targetId, error) {
        ...
        assert(this.queriesByTarget.has(targetId) &&
            this.queriesByTarget.get(targetId).length !== 0, "There are no queries mapped to target id " + targetId);
        for (var _i = 0, _a = this.queriesByTarget.get(targetId); _i < _a.length; _i++) {
            var query = _a[_i];
            this.queryViewsByQuery.delete(query);
            if (error) {
    ...
    SyncEngine.prototype.synchronizeQueryViewsAndRaiseSnapshots = function (targets) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var activeQueries, newViewSnapshots, _i, targets_1, targetId, targetData, queries, _a, queries_1, query, queryView, viewChange, target;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        activeQueries = [];
    ...
    SyncEngine.prototype.applyTargetState = function (targetId, state, error) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, changes, synthesizedRemoteEvent;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (this.isPrimary) {
    ...
    SyncEngine.prototype.applyActiveTargetsChange = function (added, removed) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _i, added_1, targetId, target, targetData, _loop_1, this_1, _a, removed_1, targetId;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        targetId = added_1[_i];
                        assert(!this.queriesByTarget.has(targetId), 'Trying to add an already active target');
                        return [4 /*yield*/, this.localStore.getTarget(targetId)];
                    case 2:
                        target = _b.sent();
...
var FirestoreClient = /** @class */ (function () {
     ...
     */
    FirestoreClient.prototype.start = function (persistenceProvider, persistenceSettings) {
        var _this = this;
        ...
        this.credentials.setChangeListener(function (user) {
            if (!initialized) {
                initialized = true;
                _this.initializePersistence(persistenceProvider, persistenceSettings, user, persistenceResult)
     ...
     *     succeeded.
     */
    FirestoreClient.prototype.initializePersistence = function (persistenceProvider, persistenceSettings, user, persistenceResult) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var error_1;
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, persistenceProvider.initialize(this.asyncQueue, this.databaseInfo, this.platform, this.clientId, user, persistenceSettings)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        persistenceResult.reject(error_1);
                        // An unknown failure on the first stage shuts everything down.
                        if (!this.canFallback(error_1)) {
                            throw error_1;
                        }
                        console.warn('Error enabling offline persistence. Falling back to' +
                            ' persistence disabled: ' +
                            error_1);
                        return [2 /*return*/, this.initializePersistence(new MemoryPersistenceProvider(), { durable: false }, user, persistenceResult)];
                    case 3: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        remoteStoreOnlineStateChangedHandler = function (onlineState) {
                            return _this.syncEngine.applyOnlineStateChange(onlineState, 0 /* RemoteStore */);
                        };
                        sharedClientStateOnlineStateChangedHandler = function (onlineState) {
                            return _this.syncEngine.applyOnlineStateChange(onlineState, 1 /* SharedClientState */);
                        };
                        ...
                        this.syncEngine = new SyncEngine(this.localStore, this.remoteStore, this.sharedClientState, user, MAX_CONCURRENT_LIMBO_RESOLUTIONS);
...
var NumericIncrementTransformOperation = /** @class */ (function () {
    function NumericIncrementTransformOperation(serializer, operand) {
        ...
        assert(isNumber(operand), 'NumericIncrementTransform transform requires a NumberValue');
    }
...
var JsonProtoSerializer = /** @class */ (function () {
    ...
    JsonProtoSerializer.prototype.fromBytes = function (value) {
        if (this.options.useProto3Json) {
            assert(value === undefined || typeof value === 'string', 'value must be undefined or a string when using proto3 Json');
            return ByteString.fromBase64String(value ? value : '');
        }
        else {
            assert(value === undefined || value instanceof Uint8Array, 'value must be undefined or Uint8Array');
    ...
    JsonProtoSerializer.prototype.fromResourceName = function (name) {
        ...
        assert(isValidResourceName(resource), 'Tried to deserialize invalid key ' + resource.toString());
        return resource;
    };
    ...
    JsonProtoSerializer.prototype.fromWatchChange = function (change) {
        ...
        if ('targetChange' in change) {
            ...
            var doc = new Document(key, version, data, {});
...
var UserDataWriter = /** @class */ (function () {
    ...
    UserDataWriter.prototype.convertReference = function (name) {
        ...
        assert(isValidResourceName(resourcePath), 'ReferenceValue is not valid ' + name);
...
var Firestore = /** @class */ (function () {
    ...
    function Firestore(databaseIdOrApp, authProvider, persistenceProvider) {
        var _this = this;
        if (persistenceProvider === void 0) { persistenceProvider = new MemoryPersistenceProvider(); }
    ...
    Firestore.prototype.enablePersistence = function (settings) {
        ...
        if (settings) {
            if (settings.experimentalTabSynchronization !== undefined) {
                logError("The 'experimentalTabSynchronization' setting has been renamed to " +
                    ...
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this._persistenceProvider.clearPersistence(databaseInfo)];
                            case 1:
                                _a.sent();
                                deferred.resolve();
                                return [3 /*break*/, 3];
    ...
    Firestore.prototype.configureClient = function (persistenceProvider, persistenceSettings) {
        ...
        return this._firestoreClient.start(persistenceProvider, persistenceSettings);
    };
...
var Transaction$1 = /** @class */ (function () {
    ...
    Transaction.prototype.set = function (documentRef, value, options) {
        ...
        var _a = applyFirestoreDataConverter(ref._converter, value, 'Transaction.set'), convertedValue = _a[0], functionName = _a[1];
...
var WriteBatch = /** @class */ (function () {
    ...
    WriteBatch.prototype.set = function (documentRef, value, options) {
        ...
        var _a = applyFirestoreDataConverter(ref._converter, value, 'WriteBatch.set'), convertedValue = _a[0], functionName = _a[1];
        var parsed = options.merge || options.mergeFields
            ? this._firestore._dataReader.parseMergeData(functionName, convertedValue, options.mergeFields)
            : this._firestore._dataReader.parseSetData(functionName, convertedValue);
...
var DocumentReference = /** @class */ (function () {
    ...
    DocumentReference.prototype.set = function (value, options) {
        ...
        var _a = applyFirestoreDataConverter(this._converter, value, 'DocumentReference.set'), convertedValue = _a[0], functionName = _a[1];
        var parsed = options.merge || options.mergeFields
...
var Query$1 = /** @class */ (function () {
    ...
    Query.prototype.where = function (field, opStr, value) {
        ...
        return new Query(this._query.addFilter(filter), this.firestore, this._converter);
    };
    Query.prototype.orderBy = function (field, directionStr) {
        ...
        return new Query(this._query.addOrderBy(orderBy), this.firestore, this._converter);
    };
    Query.prototype.limit = function (n) {
        validateExactNumberOfArgs('Query.limit', arguments, 1);
        validateArgType('Query.limit', 'number', 1, n);
        validatePositiveNumber('Query.limit', 1, n);
        return new Query(this._query.withLimitToFirst(n), this.firestore, this._converter);
    };
    Query.prototype.limitToLast = function (n) {
        ...
        return new Query(this._query.withLimitToLast(n), this.firestore, this._converter);
    };
    Query.prototype.startAt = function (docOrField) {
        ...
        /*before=*/ true);
        return new Query(this._query.withStartAt(bound), this.firestore, this._converter);
    };
    ...
    Query.prototype.endBefore = function (docOrField) {
        ...
        /*before=*/ true);
        return new Query(this._query.withEndAt(bound), this.firestore, this._converter);
    };
     ...
     * server timestamp.
     */
    Query.prototype.boundFromDocument = function (doc, before) {
        var components = [];
    ...
    Query.prototype.validateHasExplicitOrderByForLimitToLast = function (query) {
...
function changesFromSnapshot(firestore, includeMetadataChanges, snapshot, converter) {
    if (snapshot.oldDocs.isEmpty()) {
        ...
        return snapshot.docChanges.map(function (change) {
            ...
            assert(change.type === 0 /* Added */, 'Invalid event type for first snapshot');
...
function configureForFirebase(firebase, firestoreFactory) {
    ...
    }, "PUBLIC" /* PUBLIC */).setServiceProps(tslib.__assign({}, firestoreNamespace)));
}
...
function loadProtos() {
    ...
    var packageDefinition = protoLoader.loadSync(firestoreProtoFile, tslib.__assign(tslib.__assign({}, protoLoaderOptions), { includeDirs: [root] }));
